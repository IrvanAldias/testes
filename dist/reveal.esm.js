  ...
  startEmbeddedIframe(e) {
    ...
    if (t && t.contentWindow) {
      ...
      if (i && s) {
        ...
        "boolean" != typeof e &&
          (e = t.hasAttribute("data-autoplay") || !!o(t, ".slide-background")),
            ...
            t(i, ".slide-background").forEach((e, t) => {
              e.classList.remove("past", "present", "future"),
                t < s.v
                  ...
                  : (e.classList.add("present"), r === s.h && (n = e));
            });
      }),
...
class P {
  ...
  autoAnimateElements(e, t, i, s, n) {
    ...
    if (
      ...
      (e.className.match(C) || [""])[0] === (t.className.match(C) || [""])[0] &&
        ...
        "string" == typeof t && (t = { property: t }),
          void 0 !== t.from && "from" === e
            ...
            : ("line-height" === t.property &&
                (i = parseFloat(a["line-height"]) / parseFloat(a["font-size"])),
...
function Y(a, l) {
  ...
  function Te(e) {
    "string" == typeof e.layout && (j.layout = e.layout),
      ...
      j.layout
        ? n(Y.slides, j.layout + " " + j.overview)
        : n(Y.slides, j.overview);
  }
  function Fe({ target: t = Y.wrapper, type: i, data: s, bubbles: n = !0 }) {
  ...
  function ze(t, i) {
    if (E.postMessageEvents && window.parent !== window.self) {
      let s = { namespace: "reveal", eventName: t, state: xt() };
  ...
  function Ve(e, t) {
    ...
    return (
      (n.presentationWidth -= n.presentationWidth * E.margin),
      (n.presentationHeight -= n.presentationHeight * E.margin),
  ...
  function ct(e, i) {
    let s = t(Y.wrapper, e),
      ...
      r = !1;
    if (n) {
      E.loop && (i >= n && (o = !0), (i %= n) < 0 && ((i = n + i), (r = !0))),
      ...
      for (let e = 0; e < n; e++) {
        ...
        t.classList.remove("past"),
          ...
          a
            ...
            : e < i
            ? (t.classList.add(n ? "future" : "past"), E.fragments && ht(t))
            : e > i
            ? (t.classList.add(n ? "past" : "future"), E.fragments && ut(t))
    ...
    if (n && void 0 !== u) {
      ...
      for (let o = 0; o < n; o++) {
        ...
        if (
          ...
          for (let s = 0; s < d; s++) {
            let n = l[s];
            (i = o === (u || 0) ? Math.abs((v || 0) - s) : Math.abs(s - t)),
              e + i < a ? ee.load(n) : ee.unload(n);
          }
        }
      }
      St()
    ...
    if ((Mt(), m && !1 !== E.autoSlide)) {
      ...
      i
        ...
        !J ||
          ...
          ((G = setTimeout(() => {
            "function" == typeof E.autoSlideMethod ? E.autoSlideMethod() : Ot(),
              Nt();
          }, J)),
          (Q = Date.now())),
        f && f.setPlaying(-1 !== G);
  ...
  const _t = {
    ...
    stopEmbeddedContent: () => ee.stopEmbeddedContent(m, { unloadIframes: !1 }),
    showPreview: Oe,
    hidePreview: je,
